...
![GPT-5.6 Luna vs Claude coding benchmark](docs/benchmark-results-315605f.svg)
...
![Click comparison](docs/popular-click-315605f.svg)

![Requests comparison](docs/popular-requests-315605f.svg)
